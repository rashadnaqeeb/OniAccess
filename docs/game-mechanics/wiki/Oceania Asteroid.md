...
DLC, see
Oceania Asteroid (Spaced Out)
.
Oceania Asteroid
A location with vast quantities of undrinkable salt water.
Oceania is quite stable and resource rich, but the majority of the area is covered in a saltwater ocean. Careful expansion and resource usage should lead to a successful colony.
Coordinate
OCAN-A
World Size
256 x 384
...
, the
Printing Pod
spawns about 80 tiles closer to the bottom of the world (and thus the
Oily Biome
), resulting in a shorter trip to obtain oil and a lengthier trip to the
Space Biome
.
Map Layout
Note the large Ocean Biomes full of deep pools of Salt Water, and note that the Printing Pod spawns much closer to the bottom of the map than other
Asteroid Types
.
Example Oceania Asteroid Layout
Strategy
While the
Starting Biome
does have large amounts of water to
Electrolyze
Water
for
Oxygen
, there are much larger amounts of
Salt Water
all across the map.
Pips
are not available anywhere on the asteroid and can only be obtained from the
Printing Pod
with
Care Packages
enabled or from
Space Destinations
. The same goes for the missing plants:
Arbor Trees
,
Oxyferns
, and
