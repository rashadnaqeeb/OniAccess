...
.
Volcanea Cluster
A cluster of planets with a toasty planetoid full of molten lava pockets to start on.
Coordinate
V-VOLCA-C
Cluster Type
Classic Style Cluster
Starting Planetoid
Volcanea Asteroid
...
localizationId
STRINGS.CLUSTER_NAMES.VANILLA_VOLCANIC_CLUSTER.NAME
The
Volcanea Cluster
is a
Planetoid Cluster
