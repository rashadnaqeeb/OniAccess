...
Colonizing Arboria will require careful planning right from the start. Because of its lack of metals, finding biological solutions to problems is a must.
World Size
240 x 380
Cosmic Radiation
125 rads/cycle
...
Code
internalId
expansion1::worlds/VanillaArboria
localizationId
STRINGS.WORLDS.VANILLAARBORIA.NAME
Map Layout
Example Arboria Asteroid Layout
Strategy
