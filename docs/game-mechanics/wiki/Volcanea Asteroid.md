...
DLC, see
Volcanea Asteroid (Spaced Out)
.
Volcanea Asteroid
A location rife with molten lava pockets and intense heat.
Volcanea would be perfect if it wasn't for the volcanoes. Digging carefully and managing the temperatures in our colony will be essential to success.
Coordinate
VOLCA
World Size
256 x 384
...
is one of the
Asteroid Types
available to start on. It is a hotter variant of
Terra
with multiple guaranteed magma vents at most altitudes, not all of which are completely sealed off by
Abyssalite
.
The Magma Channels
World Trait
does
stack with Volcanea's guaranteed magma vents, and may result in the
Oily Biome
being difficult to find and/or require tunneling through hot
Obsidian
to reach. Players seeking a challenge may want to give that a try.
Map Layout
In the
Volcanea
layout, the
...
arises higher, and
Space Biome
cuts in deeper, sometimes resulting in floating biomes within the
Space Biome
.
Example Volcanea world. Notice the magma vents.
Strategy
The raised magma vents may result in geothermal power plants constructed with
Steam Turbines
being more convenient as a power source due to them being physically closer to the Printing Pod.
Pips
,
Arbor Trees
,
...
Volcanea Asteroid
. The player will have to wait for
Printing Pod
to print them, or source them from
Space Destinations
.
Nosh Sprouts
are completely unobtainable.
Worldgen Information
Biomes
Volcanea Asteroid
...
Volcano
Water Geyser
Advanced Geyser and Points of Interest Details
Geysers
(0–17 Geysers)
Rule
Geysers
...
×3
Gallery
The sad remains of a
Swamp Biome
that generated next to an uninsulated magma vent.
The player may have to dig through hot Obsidian to reach oil.
See also
Asteroid Types
Biomes
Starmap
