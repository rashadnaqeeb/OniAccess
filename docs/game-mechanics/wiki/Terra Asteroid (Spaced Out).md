...
Terra meets all the requirements for Duplicant life and holds no surprises. It's an ideal location for a first attempt at establishing a colony.
World Size
240 x 380
Cosmic Radiation
125 rads/cycle
...
Code
internalId
expansion1::worlds/VanillaSandstoneDefault
localizationId
STRINGS.WORLDS.VANILLASANDSTONEDEFAULT.NAME
Terra
is a large starting asteriod with a
Sandstone Biome
start. The starting area is surrounded by
Marsh
,
Jungle
,
