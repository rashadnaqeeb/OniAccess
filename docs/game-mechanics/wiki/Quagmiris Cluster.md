...
.
Quagmiris Cluster
A swampy cluster of visitable planetoids made from the remains of an anomalous planet.
Coordinate
SWMP-C
Cluster Type
Spaced Out! Style Cluster
Starting Planetoid
Quagmiris Asteroid
Teleport Target Planetoid
Rusty Oil Asteroid
Other Inner Planetoids
...
History
Old picture of how asteroids and clusters looked
