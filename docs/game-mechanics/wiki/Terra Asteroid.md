...
is one of the
Asteroid Types
available to start on. It is the default asteroid type, and was the default map preset before the
Launch Update
.
Map Layout
...
for
Oxygen
, and there are several different sources all across the map.
Pips
