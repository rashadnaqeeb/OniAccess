...
Asteroid Types
available. Due to several factors Verdante Asteroid can be considered a preset of advanced difficulty. It's oil biome can be found in unexpected places, similar to the effects of the Irregular Oil
World Trait
.
Map Layout
Example Verdante Asteroid Layout
Strategy
While
Hatches
can't normally be found in any
Biomes
on the asteroid, one does spawn to the left of the printing pod buried in a tile. If this hatch is lost though, more can be obtained from
Space Destinations
or from the
Printing Pod
with
Care Packages
.
There are 3 plants not available anywhere on the asteroid:
Bristle Blossoms
,
Wheezeworts
, and
Sleet Wheat
. These can be found in can only be obtained from the
Printing Pod
with
Care Packages
