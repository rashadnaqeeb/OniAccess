	...
	public class ONIACCESS {
		...
		public class DETAILS {
			...
			public class PATHING_DESC {
				...
				// Appended to DUPLICANT when the duplicant has the CanSwim perk
				public static LocString DUPLICANT_SWIM = "Can also swim through liquid in any direction, dive in from ledges up to 2 tiles above the water, climb out onto ledges up to 2 tiles above the surface, and grab ladders and fire poles directly from the water. Swimming in an atmo suit, jet suit, or lead suit is much slower.";
				...
				public static LocString WALKER_1X1_NOJUMP = "Occupies 1 tile. Walks on solid ground. Can climb or descend ledges 1 tile tall, but cannot cross gaps or climb taller ledges, unlike most walkers.";
				...
				public static LocString SWIMMER_1X2 = "Occupies 1 wide by 2 tall. Swims through liquid in any direction. On dry land, flops around searching for nearby liquid but cannot walk. Needs deeper liquid than 1-tile swimmers due to its height.";
				public static LocString SWIMMER_2X2 = "Occupies 2 wide by 2 tall. Swims through liquid in any direction. On dry land, flops around searching for nearby liquid but cannot walk. Needs deeper and wider liquid than smaller swimmers due to its size.";
		...
		public class DUPE_DESCRIPTIONS {
			...
			public static LocString KAI = "Tan skin and a shaggy golden-blonde bob that falls around their face in loose beachy waves, like they just wandered up from the surf and shook dry. Their expression is calm and unbothered, small dark eyes and a relaxed little smile. They wear a deep red top over black pants patterned with fish scales like a wetsuit, with gold trim at the cuffs and belt. The whole outfit says lifeguard; the face says nap.";
			public static LocString MINNOW = "Pale porcelain skin and a tumble of pearlescent hair that fades from pinkish white at the crown through lavender to purple at the tips, with bright blue and pink streaks tucked underneath and choppy bangs sweeping across her forehead. A sprinkle of small blue dots marks her cheeks, like freckles that decided to be sea spray instead. She has big round dark eyes and a gentle, contented smile. She wears a dusty purple top over black fish-scale-patterned pants, with sky-blue gloves and matching blue trim.";
		}
		...
		public class CRITTER_DESCRIPTIONS {
			...
			public static LocString SNAIL = "A snail almost entirely hidden beneath a huge cone-shaped spiral shell in pale pink and cream, carried on its back with the pointed tip angled up and behind it. Soft ridged bands wrap around the shell's curve. A small beige body pokes out from the wide opening at the front: a wedge-shaped head with two ear-like stubs, dark dot eyes, and a pointed little snout, like a tiny mouse peeking out from under its house. It rides on a flat skirt-like foot that hugs the ground.";
			public static LocString SNAILIRON = "A Slogo variant that traded the soft pink shell for full battle armor. Its shell is deep plum-black, bristling with tall dark-crimson spikes and dotted with oval golden studs between them. The body underneath is dark maroon, nearly black, with two glowing white dot eyes and a few small spikes of its own. The whole package looks less like a snail and more like a spiked mace someone left on the beach.";
			public static LocString SEAHORSE = "A seahorse with a deep blue-violet body speckled in tiny white dots, like a piece of night sky bent into an S-curve. A fan of magenta-pink spiny fins crests the back of its head, with a matching smaller fan on its back. Its segmented belly is pale pink, its snout is a long upturned tube, and it has a large dark eye and two small antenna stubs on top of its head. It floats upright with its tail curled beneath it.";
			public static LocString SQUID = "An upright squid wearing its deep crimson mantle like a drooping nightcap, swept back to a point, with two ear-like fins at the crown. The mantle is dusted with darker speckles that light up in pinks and blues when it glows. Beneath it, a thick beard of wavy orange tentacles hangs down like a mop, with two longer, thinner arms dangling at the sides, and a pale face peeking out between hood and beard.";
			public static LocString SEATURTLE = "A sea turtle with a pale green body and a low, dark green domed shell crowned by a cluster of tall sky-blue crystal shards, like a walking mineral deposit. Its head sports two big googly white eyes set close together above a small snout. Sturdy flippers stick out from under the shell, and a forked fish-tail fin trails behind.";
			public static LocString PARROTFISH = "A stubby fish that looks assembled from overlapping purple fans, each pleated segment trimmed in gold where it meets the next. Its oversized head is a smooth purple plate ending in a sharp parrot-like beak with a dark zigzag mouth line, and it has a round cream-gold eye. The tail flares out in a bat-wing-shaped fluke. The overall effect is somewhere between a fish and an art deco lamp.";
			public static LocString PUFFERFISH = "A plump fish with a turquoise back smudged with orange-brown patches and dashed with short dark spines lying flat, over a cream-yellow belly. Three googly eyes with yellow pupils cluster above an enormous flat orange bill. Its fins and broad tail are striped in tan and cream. It can puff up into a near-perfect spiked ball, teal on top and cream underneath.";
			public static LocString SEAFAIRY = "A critter that looks exactly like a swimming kelp leaf. Its head is a smooth green teardrop with a round yellow eye and a tiny open mouth at the tip, and its body trails behind as a long leaf-blade tail in layered greens with darker veins. Only the eye gives it away as an animal rather than a piece of drifting seaweed.";
		}
	}
}
